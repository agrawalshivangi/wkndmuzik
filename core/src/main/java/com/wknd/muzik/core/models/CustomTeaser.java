...
@Model(adaptables = SlingHttpServletRequest.class, adapters = {Teaser.class,CustomTeaser.class}, resourceType = "wkndmuzik/components/teaser",defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL)
